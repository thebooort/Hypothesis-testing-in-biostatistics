...
En este caso el estadístico sigue una distribución F de Snedecor y, el test, viene dado por el siguiente planeamiento:
...
\end{itemize}
Para el calculo final seguimos los mismos procedimientos que en el apartado para una población, utilizando la tabla de la distribución F de Snedecor.
