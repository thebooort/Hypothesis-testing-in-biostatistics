...
Por tanto, esto se puede resolver por un test de razón de verosimilitudes, aunque la tradición clásica hace que el estadístico a usar normalmente sea otro que da los mismos resultados \todo{cuál??}. Esto se debe a que el test de razón de verosimilitudes es posterior a los test $\chi^2$.
\\
...
\todo{qué significa $F_{\theta}$ y $\Theta$?}
...
\todo{no sé proceder análogamente}
