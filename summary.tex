...
\subsubsection{Errores}
    ...
    Por otro, a la probabilidad de no cometer un error tipo II, esto es, de rechazar $H_0$ cuando esta es falsa, se la conoce como \textbf{potencia del test}.\todo{no hay alguna notacación para esto?}
